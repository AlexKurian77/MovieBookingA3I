        ...
        <nav class="box hidden">
            ...
            <div class="list">
                <ul>
                    ...
                    <li id="logout_show" onclick="logout1();"><span></span><img src="https://static-00.iconduck.com/assets.00/log-out-icon-2048x2048-cru8zabe.png" width="15px" height="19px" id="logout">Log Out</li>
